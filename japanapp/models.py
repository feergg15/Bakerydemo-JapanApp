...
class Userfer(AbstractUser):
    ...
    class Meta:
        # Opciones de meta de tu modelo
        pass

    # Definir related_name para grupos y user_permissions
    groups = models.ManyToManyField(
        Group,
        verbose_name=('groups'),
        blank=True,
        related_name='userfers_groups'  # Nombre personalizado para el acceso inverso de grupos
    )
    user_permissions = models.ManyToManyField(
        Permission,
        verbose_name=('user permissions'),
        blank=True,
        related_name='userfers_permissions'  # Nombre personalizado para el acceso inverso de permisos de usuario
    )
...
class Proyecto(models.Model):
    usuario = models.ForeignKey(Userfer, related_name="usuario", on_delete=models.CASCADE,default=1)
